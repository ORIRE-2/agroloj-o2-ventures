...
import { Loader2, Sprout, Zap, Calendar, Clock } from "lucide-react"

interface CropAndLivestockAdvisoryPaymentButtonProps {
...
export function CropAndLivestockAdvisoryPaymentButton({
  onSuccess,
  onError,
  className = "",
  variant = "full",
}: CropAndLivestockAdvisoryPaymentButtonProps) {
  ...
  const product = products?.find(
    (p) => p.id === PRODUCT_CONFIG.PRODUCT_6a46549197599cc77038c088
  )
