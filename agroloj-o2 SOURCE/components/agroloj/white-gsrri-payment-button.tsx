...
interface WhiteGsrriPaymentButtonProps {
  onSuccess?: (result: any) => void
  onError?: (error: any) => void
  className?: string
}

export function WhiteGsrriPaymentButton({
  onSuccess,
  onError,
  className = "",
}: WhiteGsrriPaymentButtonProps) {
  ...
  const product = products?.find(
    (p) => p.id === PRODUCT_CONFIG.PRODUCT_6a443d535bf578647592daf2
  )
