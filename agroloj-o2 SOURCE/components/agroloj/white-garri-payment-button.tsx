...
interface WhiteGarriPaymentButtonProps {
  onSuccess?: (result: any) => void
  onError?: (error: any) => void
  className?: string
}

export function WhiteGarriPaymentButton({
  onSuccess,
  onError,
  className = "",
}: WhiteGarriPaymentButtonProps) {
  ...
  const product = products?.find(
    (p) => p.id === PRODUCT_CONFIG.PRODUCT_6a451696b540dc0f255470fd
  )
